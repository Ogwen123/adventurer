...
public class DebugManager {
    ...
    public void draw(Graphics2D g2d) {
        ...
        if (Config.Debug.highlightCollisionChecks) {
            g2d.fillRect(tileManager.tileCoordToScreenLoc(collisionX1, Entity.Plane.X) + gamePanel.cameraX, tileManager.tileCoordToScreenLoc(collisionY, Entity.Plane.Y) + gamePanel.cameraY, Config.tileSize, Config.tileSize);
            g2d.fillRect(tileManager.tileCoordToScreenLoc(collisionX2, Entity.Plane.X) + gamePanel.cameraX, tileManager.tileCoordToScreenLoc(collisionY, Entity.Plane.Y) + gamePanel.cameraY, Config.tileSize, Config.tileSize);
        }
    }
}
